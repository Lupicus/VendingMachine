...
{
	public static final Block VENDING_MACHINE = new VendingMachine(Properties.create(Material.IRON).notSolid().hardnessAndResistance(3.5F).sound(SoundType.METAL).lightValue(8).harvestTool(ToolType.PICKAXE).harvestLevel(3)).setRegistryName("vending_machine");
